...
[^1]: SEAD/Clean Energy Ministerial, "Street Lighting and Dark Skies" (2012). Original estimate of 1–3% of total electricity demand; LED conversion has likely reduced this, but the range remains defensible during operating hours when overall grid demand is lower.
[^2]: [The Streetlight Effect, Reversed](https://www.photometrics.ai/concepts/) — Ari Isaak, Photometrics AI.
[^3]: IEA via pv magazine, ["Solar Supplied Over 10% of Global Electricity Consumption in 2024"](https://pv-magazine-usa.com/2025/04/15/solar-supplied-over-10-of-global-electricity-consumption-in-2024/) (April 2025).
[^4]: California Energy Commission, [2024 Total System Electric Generation](https://www.energy.ca.gov/data-reports/energy-almanac/california-electricity-data/2024-total-system-electric-generation). Solar: 21.3% of power mix; clean energy: 62%.
[^5]: IEA, [Renewables 2025](https://www.iea.org/reports/renewables-2025/renewable-electricity). Variable renewables (solar PV + wind) projected at ~27–30% of global electricity by 2030, up from 17% in 2024.
...
[^7]: [AB 719 Assembly Bill — Bill Analysis](https://claude-sources.s3.us-west-2.amazonaws.com/AB%20719%20Assembly%20Bill%20-%20Bill%20Analysis.pdf). See also: U.S. DOE streetlight ownership data.
[^8]: [CPUC, Avoided Cost Calculator Documentation, 2024](https://claude-sources.s3.us-west-2.amazonaws.com/cpuc-acc-documentation-2024.pdf).
