---
title: "Best Practices for Dark Sky"
linkTitle: "Dark Sky"
subtitle: "We didn't lose the stars. We buried them under light we don't need."
description: "How precision street lighting helps cities reduce skyglow and support DarkSky International goals — without sacrificing safety."
...
<h2 style="border-top: none; padding-top: 0;">The False Binary: Safety vs. Dark Sky</h2>

Dark sky advocates are often told they have to choose: accept the light pollution, or accept the safety risk. This is a [false binary](/concepts/#false-binary). It assumes that the only way to provide safety is to over-illuminate, that every streetlight must run at full power, all night, regardless of whether anyone is there.

The evidence doesn't support that assumption. Research consistently shows that the *placement* and *quality* of light matters far more than the *quantity*. Uniformly bright streets can actually impair visibility by creating glare and reducing contrast. Over-lighting residential areas at 3 AM doesn't prevent crime. [The data shows that roughly half of all crime occurs during daylight hours, and only about 20% happens in public rights-of-way](/best-practices/public-safety/).
...
<h2 style="border-top: none; padding-top: 0;">What DarkSky International Is Asking For</h2>
...
1. **All light should have a clear purpose.** Before installing or replacing a light, determine if it's truly needed.
2. **Light should be directed only to where needed.** Shielding and aiming prevent light from spilling into the sky and neighboring properties.
3. **Light should be no brighter than necessary.** Use the minimum intensity required for the task.
4. **Light should be used only when useful.** Dimming and controls should reduce light when full output isn't needed.
5. **Warmer-color lights should be used where possible.** Lower color temperatures (under 3000K) reduce ecological disruption and scatter less in the atmosphere.
...
<h2 style="border-top: none; padding-top: 0;">How Precision Lighting Delivers Dark Sky Compliance</h2>

Photometrics AI optimizes street lighting at the individual luminaire level, using [Target Lighting Layers](/concepts/#target-lighting-layer) to define exactly how much light each surface needs. Every road segment, sidewalk, and intersection gets the illumination its classification requires, and nothing beyond that.
...
- **Timing:** [Context-aware lighting](/concepts/#context-aware-lighting) adjusts output based on time of night, day of week, and real-time conditions. Late-night dimming directly reduces the hours of maximum skyglow contribution.
...
<h2 style="border-top: none; padding-top: 0;">Dark Sky and Migratory Birds: The Same Solution</h2>
...
<h2 style="border-top: none; padding-top: 0;">Advocates Can Do More Than Observe</h2>
...
Our [Take Action](/take-action/?priorities=Light+Pollution) tool identifies the officials in your area who influence street lighting decisions and helps you draft a personalized letter asking them to evaluate precision lighting. It takes a few minutes. The letter cites real research. And it lands in the inbox of someone who can actually change things.

## How to Apply

*Practical guidance for dark sky advocacy groups and municipalities pursuing DarkSky International recognition is in development. [Contact us](/contact/) to discuss your community's specific situation.*

[^1]: Falchi, F., et al. "The new world atlas of artificial night sky brightness." [*Science Advances*, 2016.](https://www.science.org/doi/10.1126/sciadv.1600377)
[^2]: Kyba, C.C.M., et al. "Citizen scientists report global rapid reductions in the visibility of stars from 2011 to 2022." [*Science*, 2023.](https://www.science.org/doi/10.1126/science.abq7781)
[^3]: DarkSky International. ["Five Principles for Responsible Outdoor Lighting."](https://darksky.org/resources/guides-and-how-tos/lighting-principles/)
[^4]: DarkSky International. ["Create state and local outdoor lighting codes."](https://darksky.org/what-we-do/advancing-responsible-outdoor-lighting/darksky-outdoor-lighting-codes/)
