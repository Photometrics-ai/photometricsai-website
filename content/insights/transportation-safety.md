...
<button class="chart-expand-btn" onclick="openChartModal('/insights/transportation-safety/fars_analysis.html')" title="Expand chart">⛶</button>
</div>
...
<button class="chart-expand-btn" onclick="openChartModal('/insights/transportation-safety/nighttime_analysis.html')" title="Expand chart">⛶</button>
</div>
...
.chart-expand-btn:hover {
  background: rgba(78, 163, 220, 0.25);
  color: #fff;
}
.chart-modal-overlay {
  display: none;
...
<div class="chart-modal-overlay" id="chartModal" onclick="closeChartModal(event)">
  <div class="chart-modal-content">
    <button class="chart-modal-close" onclick="closeChartModal()" title="Close">✕</button>
    <iframe id="chartModalIframe" src="" scrolling="auto"></iframe>
  </div>
</div>

<script>
function openChartModal(src) {
  document.getElementById('chartModalIframe').src = src;
...
function closeChartModal(e) {
  ...
  document.getElementById('chartModalIframe').src = '';
