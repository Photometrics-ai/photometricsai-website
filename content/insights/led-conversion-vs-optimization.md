...
[^1]: LED conversion cost ranges based on [Maryland Municipal LED Streetlight Program data](https://energy.maryland.gov/govt/Documents/NEWSLETTER%20Formatted%20Jul%202021.pdf) ([archived copy](https://claude-sources.s3.us-west-2.amazonaws.com/public/maryland-municipal-led-streetlight-program-2021.pdf)) and [DOE Better Buildings Outdoor Lighting Toolkit](https://betterbuildingssolutioncenter.energy.gov/solutions-at-a-glance/cost-savings-analysis-led-street-lighting-ownership) ([archived copy](https://claude-sources.s3.us-west-2.amazonaws.com/public/doe-better-buildings-led-street-lighting-cost-savings.html)). Audit and data management costs from direct project experience across 100+ municipal clients.

[^2]: Full value methodology and sources available at [The Numbers](https://www.photometrics.ai/benefits/).

[^3]: Utility cost avoidance methodology based on the CPUC 2024 ACC Electric Model v1b. Full analysis at [Calculating the Value of Street Light Optimization for Utilities](https://www.photometrics.ai/insights/utility-cost-avoidance/).

[^4]: [DOE Municipal Solid-State Street Lighting Consortium survey](https://eta-publications.lbl.gov/sites/default/files/regulatory_issues_and_approaches_to_municipal_led_street_lighting_conversions.pdf) ([archived copy](https://claude-sources.s3.us-west-2.amazonaws.com/public/doe-lbnl-municipal-led-street-lighting-regulatory-issues.pdf)): utilities own approximately 60% of street lights in the U.S.
