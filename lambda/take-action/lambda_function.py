...
THE ASK:
Ask the representative to evaluate Photometrics AI as a solution for their community and to reach out to the company directly to learn more. Do not mention pricing, pilot scope, number of luminaires, or dollar amounts — a citizen would not know these details. The ask should feel like a concerned resident pointing them toward a technology worth investigating, not a sales pitch.
"""
